...
![image](https://github.com/user-attachments/assets/b4407452-6279-4e43-85e4-2ef80bf1e0e6)
...
![image](https://github.com/user-attachments/assets/02d41c55-5251-405e-9fc0-141415df77be)

Рисунок 7 - Схема проекта

На рисунке 8 представлена схема части проекта в ДЦ по просмотре ленты.

![image](https://github.com/user-attachments/assets/d8ecea63-cd70-4848-b50f-9ee9d34534e2)

Рисунок 8 - Схема проекта

На рисунке 9 представлена схема части проекта в ДЦ по просмотру пинов и добавлению их в сохранённые.

![image](https://github.com/user-attachments/assets/a398b610-deda-4c09-b4d1-88ae0f9519f4)

Рисунок 9 - Схема проекта

На рисунке 10 представлена схема части проекта в ДЦ по созданию/редактированию/удалению пинов.

![image](https://github.com/user-attachments/assets/074161c3-261a-4ee9-92ce-89914c66d7a6)
