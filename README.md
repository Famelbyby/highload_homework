...
![image](https://github.com/user-attachments/assets/b3b01778-5a5d-4904-9a9d-f6ea6f012228)

Рисунок 6 - Схема проекта

На рисунке 7 представлена схема части проекта в ДЦ по просмотре ленты.

![image](https://github.com/user-attachments/assets/d8ecea63-cd70-4848-b50f-9ee9d34534e2)

Рисунок 7 - Схема проекта

На рисунке 8 представлена схема части проекта в ДЦ по просмотру пинов и добавлению их в сохранённые.

![image](https://github.com/user-attachments/assets/ba3c11ec-46e6-45bb-9904-5d947a19c2ef)

Рисунок 8 - Схема проекта

На рисунке 9 представлена схема части проекта в ДЦ по созданию/редактированию/удалению пинов.

![image](https://github.com/user-attachments/assets/50476bb2-d3cf-4f6b-b25a-d4438d7f5738)

Рисунок 9 - Схема проекта

На рисунке 10 представлена легенда показанных выше схем.

![image](https://github.com/user-attachments/assets/b4407452-6279-4e43-85e4-2ef80bf1e0e6)

Рисунок 10 - Легенды схем проекта
