...
Пример для таблицы 22:
apple - 21 / (21 + 14 + 6) = 21 / 41 = 0.51, bench = 14 / 41 = 0.34, village = 0.15.
...
| pins    | 11 012 RPS                           | 40    | 80        | 3.173 Gb/s  |
| create  | 3 389 RPS                            | 20    | 60        | 3.44 Gb/s   |
| feed    | 5 806 RPS                            | 25    | 75        | 16.44 Gb/s  |

Таким образом, можно составить таблицы 24, 25 и 26.

Таблица 24 - Хостинг для своих сервисов

| Название  | Хостинг | Конфигурация                     | Cores | Cnt  | Покупка   | Аренда   |
|:---------:|:-------:|:--------------------------------:|:-----:|:----:|:---------:|:--------:|
| kubernode | own     | 2x6338/16x32GB/2xNVMe4T/2x25Gb/s | 64    | 40   | 208 000 $ | 2 000 $ (240 000 $ for 5 years)   |

Таблица 25 - Сервисы в орекстрации
...
Таблица 26 - БД сервисов и их ресурсы

| Название БД | Сервис            | Целевая пиковая нагрузка   | CPU  | RAM (GB)   | Cnt |
|:-----------:|:-----------------:|:--------------------------:|:----:|:----------:|:---:|
| Redis       | every (for auth)  | 21 303 (per all)           | 8    | 32         | 19  |
| MongoDB     | every             | 20 000 (per all)           | 16   | 32         | 50  | 
| Kafka       | pins + create     | 7 000                      | 8    | 32         | 9   |
