...
![image](https://github.com/user-attachments/assets/911510d5-4e8b-449f-b046-d12b67a67f3f)

**Рисунок 4** - Диаграмма отношений выделенных таблиц

*Примечание:* 
  - хранилищами для файлов является HDFS
...
| Tag                     | было добавлено поле pins_id, где прописаны ID пинов, подобранных под конкретный пин |
...
| User                    | количество пользователей не так много, так что был выбран PostgreSQL |
| Pin                     | количество данных очень велико - была выбрана MongoDB |
| Saved_pins              | количество данных очень велико - была выбрана MongoDB  |
| Tag                     | количество тэгов не так много, так что был выбран PostgreSQL |
...
Шардирование таблиц будет сделано по следующим критериям:
  ...
  - таблицу пинов шардировать по модулю от ID пользователя
  - таблицу тэгов - по первым буквам
